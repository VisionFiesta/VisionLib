...
namespace VisionLib.Common.Logging
{
    public sealed class ClientLog : ColorfulConsoleLogger
    {
        ...
        private static ClientLog Instance => _instance ?? (_instance = new ClientLog());
        ...
        public static void Chat(ClientLogChatType type, string sender, string message, bool isSelf = false)
        {
            ...
            if (sender != "")
            {
                ...
                Instance.WriteLineRaw((byte)level, prefixFormatter.ToArray());
            }
            else
            {
        ...
        public static void Chat(ClientLogChatType type, string message, bool isSelf = false)
        {
            Chat(type, "", message, isSelf);
        }
