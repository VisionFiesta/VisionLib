...
namespace Vision.Core.IO
{
	...
	public class ObjectCollection<T>
	{
		...
		public T this[byte identity] => !_objects.ContainsKey(identity) ? default : _objects[identity];
		...
		/// <param name="identity">The identity of the object.</param>
		/// <returns>The object.</returns>
		public T this[ushort identity] => !_objects.ContainsKey(identity) ? default : _objects[identity];
		...
		/// <param name="identity">The identity of the object.</param>
		/// <returns>The object.</returns>
		public T this[string identity] => !_objects.ContainsKey(identity) ? default : _objects[identity];
